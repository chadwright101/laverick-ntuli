...
export default function FlexibleDynamicSection() {
  return (
    <div className="flex flex-col max-w-[1280px] mx-auto px-5 pt-10 pb-15 gap-10 bg-darkGrey tablet:grid desktop:grid-cols-[2fr_1fr] w-full tablet:gap-0 tablet:px-10">
      <div className="flex flex-col gap-10 tablet:bg-purple tablet:px-15 tablet:py-10">
        <div className="bg-purple">
          <h2 className="flex flex-col gap-x-2 p-5 min-[320px]:text-[4.25rem] text-white tracking-[-0.1rem] min-[320px]:items-center phone:flex-row phone:flex-wrap phone:justify-center phone:leading-[130%] tablet:p-0 tablet:text-heading tablet:flex-nowrap tablet:gap-x-2.5 tablet:justify-start">
            flexible
      ...
      <div className="flex flex-col gap-10 tablet:bg-white tablet:items-center tablet:justify-center tablet:p-10">
        ...
        <ButtonLink
          href="/press-releases"
          color="purple"
          cssClasses="w-full tablet:w-fit"
        >
